...
const Ordering = ({ authrztn }) => {
  ...
  const handleCalculator = (value) => {
    ...
    const totalInput = parseFloat(newAmount) + parseFloat(newRemittanceCash);
    const updatedTotalCashierSales =
      totalCash + totalLoad + startingMoney - totalInput;
  ...
  return (
    <>
      {isLoading ? (
        <div className="loading-container" style={{ marginRight: "180px" }}>
          <FourSquare
            color="#6290FE"
            size="large"
            text="Loading Data..."
        ...
        <div className="modal-category p-1 end-shift-cal">
          ...
          <div className="shift-cal-container">
            ...
            <div className="shift-expected-cash">
              ...
              <h3>
                ₱{" "}
                {(totalCash + totalLoad + startingMoney).toLocaleString(
                  "en-US",
                  {
                    minimumFractionDigits: 2,
                    maximumFractionDigits: 2,
        ...
        <Modal.Body>
          <div className="modal-checkout-containers">
            ...
            <div className="paymentmethod-payable">
              ...
              <span>
                ₱{" "}
                {(totalIncome + startingMoney).toLocaleString("en-US", {
                  minimumFractionDigits: 2,
                  maximumFractionDigits: 2,
                })}
              </span>
