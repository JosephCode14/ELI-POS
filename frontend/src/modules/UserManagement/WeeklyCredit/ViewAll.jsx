  ...
  const filteredStudents = studentCredits.filter((item) => {
    ...
    const matchesQuery =
      ...
      item.student.first_name
        .toLowerCase()
        .includes(searchQuery.toLowerCase()) ||
      item.student.last_name.toLowerCase().includes(searchQuery.toLowerCase());
      ...
      >
        ...
        <Modal.Body className="p-0">
          <div className="modal-category mt-3">
            <div className="d-flex px-5 gap-5 justify-content-center">
              <div className="box-food d-flex p-0 mb-5">
