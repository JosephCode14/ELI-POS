          ...
          <div className="users-container">
            <div className="title-container pt-5 stud-man-container mx-1 flex-column flex-md-row">
              ...
              {authrztn.includes("CustomerList-IE") && (
                <div className="download-container" style={{flex: windowWidth >= 768 && "none"}}>
                  <button type="button" className="text-nowrap" onClick={handleDownloadTemplate}>
                    Download Template
                  </button>
                  <button
                    type="button"
